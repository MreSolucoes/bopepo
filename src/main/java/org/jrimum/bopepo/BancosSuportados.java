...
public enum BancosSuportados{
	...
	/**
	 * Tipo enumerado que representa o UNIPRIME, <strong>Uniprime Central - Central Interestadual de Cooperativas de Credito</strong>,
	 * código de compensação <strong><tt>084</tt></strong> <a href="http://www.uniprimecentral.com.br/">
	 * site</a>.
	 * 
	 * @since 0.2
	 */
	UNIPRIME("084", "03046391000173", "UNIPRIME CENTRAL - CENTRAL INTERESTADUAL DE COOPERATIVAS DE CREDITO", "Uniprime"),
